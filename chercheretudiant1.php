...
<html>
 <body>
    <form method="POST" action="chercheretudiant4.php">
        <div>
            Mot clé :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="motcle" value="<?php echo ($mc); ?>"><p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit" value="chercher"></p>
        </div>
    </form>
    <table>
        <tr>
